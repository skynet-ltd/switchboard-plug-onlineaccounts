...
public class IntegrationApplication : Application {
    ...
    public override int command_line (ApplicationCommandLine command_line) {
        ...
        try {
            var opt_context = new OptionContext ("- Google Integration");
    ...
    public ApiInfos? get_token (uint account_id) {
        ...
        try {
            ...
            auth_session.process_async.begin (session_data, "oauth2", null, (obj, res) => {
                try {
                    session_result = auth_session.process_async.end (res);
                } catch (Error e) {
                    critical (e.message);
                }
    ...
    public bool get_user_name (uint account_id) {
        ...
        try {
            ...
            var account_service = api_infos.account_service;
            account_service.account.set_display_name (mail);
            account_service.account.store_blocking ();
